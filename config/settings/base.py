...
ADMINS = [("""Ollyver Ottoboni""", "ollyverottoboni@gmail.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Django-DRF-Setup-Inicial API",
    "DESCRIPTION": "Documentation of API endpoints of Django-DRF-Setup-Inicial",
    "VERSION": "1.0.0",
